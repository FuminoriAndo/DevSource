...
namespace Project1.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   購買検収データ作成 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   購買検収データ作成の完了通知に失敗しました。
        ///購買部へ購買データの作成完了を連絡して下さい。 に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string ERR_SEND_MSG {
            get {
                return ResourceManager.GetString("ERR_SEND_MSG", resourceCulture);
            }
        }
    }
}
