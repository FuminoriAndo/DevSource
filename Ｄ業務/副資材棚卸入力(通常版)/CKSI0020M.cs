...
namespace Project1
{
    internal partial class FRM_CKSI0020M : System.Windows.Forms.Form
    {
        //*************************************************************************************
        //
        //
        ...
        static void Main()
        {
            ...
            Application.Run(new FRM_CKSI0020M());
        }
        ...
        private void GAMEN_CLEAR()
        {
            ...
            for (L_I = 0; L_I <= CKSI0020_01.G_WRK_MAX; L_I++)
            {
                CKSI0020_01.TANAOROSI[L_I].HINMOKUCD = "";
                CKSI0020_01.TANAOROSI[L_I].GYOSYACD = "";
                CKSI0020_01.TANAOROSI[L_I].HINMOKUNM = "";
                CKSI0020_01.TANAOROSI[L_I].GYOSYANM = "";
                CKSI0020_01.TANAOROSI[L_I].ZSOUKO = "";
                CKSI0020_01.TANAOROSI[L_I].ZEF = "";
                CKSI0020_01.TANAOROSI[L_I].ZLF = "";
                CKSI0020_01.TANAOROSI[L_I].ZCC = "";
                CKSI0020_01.TANAOROSI[L_I].ZSONOTA = "";
                CKSI0020_01.TANAOROSI[L_I].ZMETER = "";
            }
        }
        ...
        public short GAMEN_CHECK(short L_KBN)
        {
            ...
            for (L_I = 0; L_I <= 9; L_I++)
            {
                ...
                if (CKSI0020_01.G_SYUBETU == "1")
                {
                    TXT_GYOSYACD[L_I].Text = Strings.Space(4);
                    TXT_GYOSYACD[L_I].Enabled = false;
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + L_I].GYOSYACD = Strings.Space(4);
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + L_I].GYOSYANM = IPPAN.Space_Set("", 20, 2);
                }
                else
                {
                ...
                for (L_J = 0; L_J <= CKSI0020_01.G_WRK_MAX; L_J++)
                {
                    if (string.IsNullOrEmpty(CKSI0020_01.TANAOROSI[L_J].HINMOKUCD))
                    {
                        break;
                    }
                    if (L_J != (Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + L_I)
                    {
                        if (TXT_HINMOKUCD[L_I].Text == CKSI0020_01.TANAOROSI[L_J].HINMOKUCD && TXT_GYOSYACD[L_I].Text == CKSI0020_01.TANAOROSI[L_J].GYOSYACD && CKSI0020_01.TANAOROSI[L_J].SFLG != "9")
                        {
                            if (L_KBN == 1)
                            {
                                TXT_HINMOKUCD[L_I].Focus();
        ...
        public short GET_COUNT(ref short L_COUNT)
        {
            ...
            for (L_I = 0; L_I <= CKSI0020_01.G_WRK_MAX; L_I++)
            {
                if (string.IsNullOrEmpty(CKSI0020_01.TANAOROSI[L_I].HINMOKUCD))
                {
                    break;
                }
                if (TXT_K_HINCD.Text == CKSI0020_01.TANAOROSI[L_I].HINMOKUCD)
                {
                    L_COUNT = L_I;
                    functionReturnValue = 0;
                    return functionReturnValue;
        ...
        public void GAMEN_SET(int L_PAGE, int L_KBN)
        {
            ...
            for (L_I = 0; L_I <= 9; L_I++)
            {
                CKSI0020_01.ST_OLD_KEY[L_I].HINMOKUCD = "";
                CKSI0020_01.ST_OLD_KEY[L_I].GYOSYACD = "";
            }

            for (L_I = 0; L_I <= 9; L_I++)
            {
                if (string.IsNullOrEmpty(CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUCD))
                {
                ...
                {
                    TXT_HINMOKUCD[L_I].Text = CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUCD;
                    LBL_HINMOKUNM[L_I].Text = Strings.Mid(CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUNM, 1, 15);
                    CKSI0020_01.G_HINMOKUNM[L_I] = Strings.Mid(CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUNM, 1, 20);
                    if (IPPAN.C_Allspace(CKSI0020_01.TANAOROSI[L_PAGE + L_I].GYOSYACD) == 0)
                    {
                        TXT_GYOSYACD[L_I].Text = Strings.Space(4);
                        TXT_GYOSYACD[L_I].Enabled = false;
                    }
                    ...
                    {
                        TXT_GYOSYACD[L_I].Enabled = true;
                        TXT_GYOSYACD[L_I].Text = CKSI0020_01.TANAOROSI[L_PAGE + L_I].GYOSYACD;
                    }
                    CKSI0020_01.ST_OLD_KEY[L_I].HINMOKUCD = CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUCD;
                    CKSI0020_01.ST_OLD_KEY[L_I].GYOSYACD = CKSI0020_01.TANAOROSI[L_PAGE + L_I].GYOSYACD;
                    if (L_KBN == 0)
                    {
                        TXT_SFLG[L_I].Text = "";
                    }
                    ...
                    {
                        TXT_SFLG[L_I].Text = CKSI0020_01.TANAOROSI[L_PAGE + L_I].SFLG;
                    }
                    TXT_ZSOUKO[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZSOUKO, "###,##0"));
                    TXT_ZEF[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZEF, "###,##0"));
                    TXT_ZLF[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZLF, "###,##0"));
                    TXT_ZCC[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZCC, "###,##0"));
                    TXT_ZSONOTA[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZSONOTA, "###,##0"));
                    TXT_ZMETER[L_I].Text = String.Format("{0,7}", C_COMMON.FormatToNum(CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZMETER, "###,##0"));
                }
            }
        }
        ...
        private short WORK_KOUSIN(C_ODBC db, int L_PAGE)
        {
            ...
            for (L_I = 0; L_I <= 9; L_I++)
            {
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].SFLG = TXT_SFLG[L_I].Text;
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZSOUKO = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZSOUKO[L_I].Text));
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZEF = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZEF[L_I].Text));
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZLF = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZLF[L_I].Text));
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZCC = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZCC[L_I].Text));
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZSONOTA = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZSONOTA[L_I].Text));
                CKSI0020_01.TANAOROSI[L_PAGE + L_I].ZMETER = SetZeroString(IPPAN2.Numeric_Hensyu3(TXT_ZMETER[L_I].Text));
            }
        ...
        private short KOSIN_MAIN(C_ODBC db, int L_PAGE)
        {
            ...
            for (L_I = 0; L_I <= 9; L_I++)
            {
                if (CKSI0020_01.TANAOROSI[L_PAGE + L_I].SFLG == "9")
                {
                    IPPAN.G_RET = DATA_KOUSIN(db, 9, L_PAGE + L_I);
                }
                else
                {
                    if (IPPAN.C_Allspace(CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUCD) != 0)
                    {
                        L_RET = SONZAI_KAKUNIN(L_PAGE + L_I);
                        if (L_RET == 0)
                        {
                            //更新判定のため、DATA_SAKUJYOにて削除済のレコードか判定する
                            if (IS_DELETED_RECORD(CKSI0020_01.TANAOROSI[L_PAGE + L_I].HINMOKUCD, CKSI0020_01.TANAOROSI[L_PAGE + L_I].GYOSYACD))
                            {
                                //削除済なので登録処理に変更する
                                L_RET = 1;
                            }
        ...
        private bool IS_DELETED_RECORD(string sHinCd, string sGyoCd)
        {
            ...
            for (int i = 0; i <= 9; i++)
            {
                if ((string.Compare(CKSI0020_01.ST_OLD_KEY[i].HINMOKUCD, sHinCd) == 0)
                 && (string.Compare(CKSI0020_01.ST_OLD_KEY[i].GYOSYACD, sGyoCd) == 0))
                {
                    //削除済
                    return true;
                }
        ...
        private short SONZAI_KAKUNIN(int L_COUNT)
        {
            ...
            IPPAN.G_SQL = IPPAN.G_SQL + "WHERE TANAYM = '" + CKSI0020_01.G_NENGETU + "' AND ";
            IPPAN.G_SQL = IPPAN.G_SQL + "HINMOKUCD = '" + CKSI0020_01.TANAOROSI[L_COUNT].HINMOKUCD + "' AND ";
            IPPAN.G_SQL = IPPAN.G_SQL + "GYOSYACD = '" + CKSI0020_01.TANAOROSI[L_COUNT].GYOSYACD + "' ";
            ...
            {
                //項目セット
                CKSI0020_01.G_AREA[j] = "";
                CKSI0020_01.G_AREA[j] = tbl.Rows[0][j].ToString();
            }

            if (Convert.ToInt32(CKSI0020_01.G_AREA[0]) == 0)
            {
                return functionReturnValue;
            }
        ...
        private short DATA_KOUSIN(C_ODBC db, int L_KBN, int L_COUNT)
        {
            ...
            switch (L_KBN)
            {
                case 0:
                    ...
                    IPPAN.G_SQL = IPPAN.G_SQL + "HINMOKUNM = '" + IPPAN.Space_Set(Strings.Trim(Strings.Mid(CKSI0020_01.TANAOROSI[L_COUNT].HINMOKUNM, 1, 20)), 20, 2) + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "GYOSYANM = '" + IPPAN.Space_Set(Strings.Trim(Strings.Mid(CKSI0020_01.TANAOROSI[L_COUNT].GYOSYANM, 1, 20)), 20, 2) + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZSOUKO = " + CKSI0020_01.TANAOROSI[L_COUNT].ZSOUKO + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZEF = " + CKSI0020_01.TANAOROSI[L_COUNT].ZEF + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZLF = " + CKSI0020_01.TANAOROSI[L_COUNT].ZLF + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZCC = " + CKSI0020_01.TANAOROSI[L_COUNT].ZCC + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZSONOTA = " + CKSI0020_01.TANAOROSI[L_COUNT].ZSONOTA + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "ZMETER = " + CKSI0020_01.TANAOROSI[L_COUNT].ZMETER + ", ";
                ...
                case 1:
                    ...
                    IPPAN.G_SQL = IPPAN.G_SQL + "('" + CKSI0020_01.G_NENGETU + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "'" + CKSI0020_01.TANAOROSI[L_COUNT].HINMOKUCD + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "'" + CKSI0020_01.TANAOROSI[L_COUNT].GYOSYACD + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "'" + IPPAN.Space_Set(Strings.Trim(Strings.Mid(CKSI0020_01.TANAOROSI[L_COUNT].HINMOKUNM, 1, 20)), 20, 2) + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + "'" + IPPAN.Space_Set(Strings.Trim(Strings.Mid(CKSI0020_01.TANAOROSI[L_COUNT].GYOSYANM, 1, 20)), 20, 2) + "', ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZSOUKO + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZEF + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZLF + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZCC + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZSONOTA + ", ";
                    IPPAN.G_SQL = IPPAN.G_SQL + CKSI0020_01.TANAOROSI[L_COUNT].ZMETER + ", ";
        ...
        private short DATA_SAKUJYO(C_ODBC db, short L_COUNT)
        {
            short functionReturnValue = 1;
            ...
            IPPAN.G_SQL = "DELETE SIZAI_TANAOROSI_TRN ";
            IPPAN.G_SQL = IPPAN.G_SQL + "WHERE TANAYM = '" + CKSI0020_01.G_NENGETU + "' AND ";
            IPPAN.G_SQL = IPPAN.G_SQL + "HINMOKUCD = '" + CKSI0020_01.ST_OLD_KEY[L_COUNT].HINMOKUCD + "' AND ";
            IPPAN.G_SQL = IPPAN.G_SQL + "GYOSYACD = '" + CKSI0020_01.ST_OLD_KEY[L_COUNT].GYOSYACD + "' ";
        ...
        public short GET_NENGETU()
        {
            ...
            CKSI0020_01.G_NENGETU = CKSI0020_01.G_AREA[0];
        ...
        public short GET_DATA(string L_TANAYM)
        {
            ...
            for (int i = 0; i < tbl.Rows.Count; i++)
            {
                for (int j = 0; j < tbl.Columns.Count; j++)
                {
                    //項目セット
                    CKSI0020_01.G_AREA[j] = "";
                    CKSI0020_01.G_AREA[j] = tbl.Rows[i][j].ToString();
                }

                CKSI0020_01.TANAOROSI[L_I].HINMOKUCD = CKSI0020_01.G_AREA[1];
                CKSI0020_01.TANAOROSI[L_I].GYOSYACD = CKSI0020_01.G_AREA[2];
                CKSI0020_01.TANAOROSI[L_I].HINMOKUNM = CKSI0020_01.G_AREA[3];
                CKSI0020_01.TANAOROSI[L_I].GYOSYANM = CKSI0020_01.G_AREA[4];
                CKSI0020_01.TANAOROSI[L_I].ZSOUKO = CKSI0020_01.G_AREA[5];
                CKSI0020_01.TANAOROSI[L_I].ZEF = CKSI0020_01.G_AREA[6];
                CKSI0020_01.TANAOROSI[L_I].ZLF = CKSI0020_01.G_AREA[7];
                CKSI0020_01.TANAOROSI[L_I].ZCC = CKSI0020_01.G_AREA[8];
                CKSI0020_01.TANAOROSI[L_I].ZSONOTA = CKSI0020_01.G_AREA[9];
                CKSI0020_01.TANAOROSI[L_I].ZMETER = CKSI0020_01.G_AREA[10];

                L_I = L_I + 1;

                if (CKSI0020_01.G_WRK_MAX < L_I)
                {
                    break;
                }
            }
        ...
        public short GYOSYA_KENSAKU(string L_CD)
        {
            ...
            CKSI0020_01.G_GYOSYANM = Strings.Mid(L_MST_AREA[1], 1, 20);
        ...
        public short HINMOKU_KENSAKU(string L_CD, short L_NO)
        {
            ...
            else
            {
                ...
                CKSI0020_01.G_HINMOKUNM[L_NO] = Strings.Mid(L_MST_AREA[1], 1, 20);
            }

            CKSI0020_01.G_SYUBETU = Strings.Mid(L_MST_AREA[2], 1, 1);

            //   13.07.02    ISV-TRUC    品目ＣＤに入力により、向先項目にフォーカスをセットする。
            CKSI0020_01.G_MUKESAKI = L_MST_AREA[3];
            //   13.07.02   ISV-TRUC end
        ...
        private void FRM_CKSI0020M_Load(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            {
                // コマンド ライン引数の受け渡し
                CKSI0020_01.G_USERID = Strings.Mid(IPPAN.G_COMMAND, 1, Strings.InStr(1, IPPAN.G_COMMAND, L_Search, CompareMethod.Binary) - 1);
                L_Command2 = Strings.Mid(IPPAN.G_COMMAND, Strings.InStr(1, IPPAN.G_COMMAND, L_Search, CompareMethod.Binary) + 1, 30);
                CKSI0020_01.G_OFFICEID = Strings.Mid(L_Command2, 1, Strings.InStr(1, L_Command2, L_Search, CompareMethod.Binary) - 1);
                CKSI0020_01.G_SYOKUICD = Strings.Mid(L_Command2, Strings.InStr(1, L_Command2, L_Search, CompareMethod.Binary) + 1, 2);
            }

            //ユーザーＩＤが副資材ユーザ以外かを見る
            IPPAN.G_RET = FS_USER_CHECK.User_Check(CKSI0020_01.G_USERID);
            if (IPPAN.G_RET != 0)
            {
                System.Environment.Exit(0);
            }
            ...
            {
                IPPAN.G_RET = IPPAN2.TIMER_SET(CKSI0020_01.G_USERID);
                if (IPPAN.G_RET != 0)
                {
                    System.Environment.Exit(0);
                }
            ...
            LBL_NEN.Text = Strings.Mid(CKSI0020_01.G_NENGETU, 1, 4);

            LBL_TUKI.Text = Strings.Mid(CKSI0020_01.G_NENGETU, 5, 2);

            //砂時計ポインタ
            IPPAN.Pointer_Change(this, IPPAN.C_CURSOR_WAIT);
            IPPAN.G_RET = GET_DATA(CKSI0020_01.G_NENGETU);
            //標準ポインタ
            IPPAN.Pointer_Change(this, IPPAN.C_CURSOR_DEFAULT);
            if (IPPAN.G_RET != 0)
            {
        ...
        {
            IPPAN.Control_Init(this, "副資材棚卸入力", "CKSI0020", SO.SO_USERNAME, SO.SO_OFFICENAME, "1.00");
        }
        ...
        private void TXT_GYOSYACD_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_GYOSYACD[Index].Text;
        ...
        private void TXT_GYOSYACD_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_GYOSYACD[Index].Text && TXT_SFLG[Index].Text != "9" && TXT_GYOSYACD[Index].Enabled == true)
            {
                ...
                else if (IPPAN.C_Allspace(TXT_GYOSYACD[Index].Text) == 0)
                {
                    ...
                    //必須項目入力エラー
                    IPPAN.Error_Msg("E200", 0, " ");
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYACD = Strings.Space(4);
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYANM = IPPAN.Space_Set("", 20, 2);
                    return;
                }
                ...
                for (L_I = 0; L_I <= CKSI0020_01.G_WRK_MAX; L_I++)
                {
                    ...
                    {
                        if (TXT_HINMOKUCD[Index].Text == CKSI0020_01.TANAOROSI[L_I].HINMOKUCD && TXT_GYOSYACD[Index].Text == CKSI0020_01.TANAOROSI[L_I].GYOSYACD)
                        {
                            TXT_GYOSYACD[Index].Focus();
                            TXT_GYOSYACD_Enter(TXT_GYOSYACD[Index], new System.EventArgs());
                            C_COMMON.Msg("入力内容が重複しています");
            ...
            CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYACD = TXT_GYOSYACD[Index].Text;
            CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYANM = IPPAN.Space_Set(Strings.Trim(Strings.Mid(CKSI0020_01.G_GYOSYANM, 1, 20)), 20, 2);
        }
        ...
        private void TXT_HINMOKUCD_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_HINMOKUCD[Index].Text && TXT_SFLG[Index].Text != "9")
            {
                if (IPPAN.C_Allspace(TXT_HINMOKUCD[Index].Text) == 0 && IPPAN.C_Allspace(TXT_GYOSYACD[Index].Text) == 0 && IPPAN.C_Allspace(TXT_SFLG[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZSOUKO[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZEF[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZLF[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZCC[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZSONOTA[Index].Text) == 0 && IPPAN.C_Allspace(TXT_ZMETER[Index].Text) == 0)
                {
                    TXT_HINMOKUCD[Index].Text = "";
                    ...
                    TXT_ZMETER[Index].Text = "";
                    TXT_GYOSYACD[Index].Enabled = true;
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].HINMOKUCD = TXT_HINMOKUCD[Index].Text;
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].HINMOKUNM = IPPAN.Space_Set(CKSI0020_01.G_HINMOKUNM[Index], 20, 2);
                    return;
                }
                ...
                if (CKSI0020_01.G_SYUBETU == "1")
                {
                    ...
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYACD = Strings.Space(4);
                    CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].GYOSYANM = Strings.StrConv(Strings.Space(20), VbStrConv.Wide, C_COMMON.G_CMN_LOCALID_JP);
                }
                else
                {
                    TXT_GYOSYACD[Index].Text = "";
            ...
            {               
                string mukesaki = CKSI0020_01.G_MUKESAKI;
                switch (mukesaki)
                {
                    case "1":
                        TXT_ZEF[Index].Focus();
        ...
        private void TXT_SFLG_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_SFLG[Index].Text;
        }
        ...
        private void TXT_SFLG_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_SFLG[Index].Text)
            {
            ...
            CKSI0020_01.TANAOROSI[(Convert.ToInt32(Strings.Mid(LBL_PAGE.Text, 1, Strings.InStr(LBL_PAGE.Text, "/", CompareMethod.Binary) - 1)) - 1) * 10 + Index].SFLG = TXT_SFLG[Index].Text;
        ...
        private void TXT_ZCC_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZCC[Index].Text;
        }
        ...
        private void TXT_ZCC_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZCC[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
        ...
        private void TXT_ZEF_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZEF[Index].Text;
        }
        ...
        private void TXT_ZEF_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZEF[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
        ...
        private void TXT_ZLF_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZLF[Index].Text;
        }
        ...
        private void TXT_ZLF_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZLF[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
        ...
        private void TXT_ZMETER_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZMETER[Index].Text;
        }
        ...
        private void TXT_ZMETER_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZMETER[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
        ...
        private void TXT_ZSONOTA_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZSONOTA[Index].Text;
        }
        ...
        private void TXT_ZSONOTA_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZSONOTA[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
        ...
        private void TXT_ZSOUKO_Enter(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            CKSI0020_01.G_CD = TXT_ZSOUKO[Index].Text;
        }
        ...
        private void TXT_ZSOUKO_Leave(System.Object eventSender, System.EventArgs eventArgs)
        {
            ...
            if (CKSI0020_01.G_CD != TXT_ZSOUKO[Index].Text)
            {
                CKSI0020_01.G_Flg = 1;
            }
