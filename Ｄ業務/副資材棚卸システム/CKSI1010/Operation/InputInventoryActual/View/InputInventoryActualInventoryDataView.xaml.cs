...
{
    /// <summary>
    /// InputInventoryActualInventoryDataActualView.xaml の相互作用ロジック
    /// </summary>
    public partial class InputInventoryActualInventoryDataView
    {
        #region コンストラクタ
        ...
        /// コンストラクタ
        /// </summary>
        public InputInventoryActualInventoryDataView()
        {
            InitializeComponent();

            this.Loaded += InputInventoryActualInventoryDataView_Loaded;
        }
        ...
        {
            var dataContext = this.DataContext as InputInventoryActualInventoryDataViewModel;
        ...
        private void InputInventoryActualInventoryDataView_Loaded(object sender, RoutedEventArgs e)
        {
            var dataContext = this.DataContext as InputInventoryActualInventoryDataViewModel;
            if (dataContext != null)
            {
