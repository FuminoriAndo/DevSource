...
namespace CKSI1010.Operation.InputPaymentCheck.View
{
    /// <summary>
    /// InputPaymentCheckView.xaml の相互作用ロジック
    /// </summary>
    public partial class InputPaymentCheckView
    {
        public InputPaymentCheckView()
        {
            InitializeComponent();
