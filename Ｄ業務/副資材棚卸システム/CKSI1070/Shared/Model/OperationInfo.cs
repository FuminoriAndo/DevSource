...
namespace Shared.Model
{
    ...
    public class OperationInfo : Singleton<OperationInfo>
    {
        ...
        /// 作業区分
        /// </summary>
        public IDictionary<string, string> WorkCategory { get; set; }
        ...
        /// グループ区分
        /// </summary>
        public IList<TanaorosiGroupKbn> GroupKbn { get; set; }

        /// <summary>
        /// 操作コード
        /// </summary>
        public IList<TanaorosiOperation> OperationCodes { get; set; }
