...
namespace Behaviors
{
    ...
    /// 棚卸操作のビヘイビア
    /// </summary>
    public class TanaorosiOperationBehaviors
    {
        public static readonly DependencyProperty IsNumericProperty =
                    DependencyProperty.RegisterAttached(
                        "IsNumeric", typeof(bool),
                        typeof(TanaorosiOperationBehaviors),
    ...
    public class TanaorosiOperationNameBehaviors
    {
        ...
        static void OnKeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (59 == length && e.Key == Key.ImeProcessed)
            {
                e.Handled = true;
            }
        }
