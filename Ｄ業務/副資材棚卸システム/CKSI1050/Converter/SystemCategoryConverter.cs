...
namespace Converter
{
    ...
    internal sealed class SystemCategoryConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (SharedModel.Instance.SystemCategory != null && !String.IsNullOrEmpty(stringValue))
            {
                systemCategory = stringValue + ":" + SharedModel.Instance.SystemCategory[stringValue];
            }
